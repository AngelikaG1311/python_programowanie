...
library1=Library("Krakow","Starowislna 5","30-001","8:00-18:00","111-222-333")
library2=Library("Krakow","Szkolna 7","30-002","8:00-16:00","444-222-333")
...
employee1=Employee("Adam","Nowak",date(2021,8,9),date(1993,12,11),"Krakow","Krolewska 4","30-009","777-333-111")
employee2=Employee("Bartosz","Mazurek",date(2022,7,5),date(1991,3,5),"Wieliczka","Solna 2","30-002","555-333-111")
employee3=Employee("Andrzej","Lasek",date(2020,4,4),date(1992,8,9),"Olkusz","Krakowska 7","30-003","777-333-888")
